...
#            --export=ALL,EPOCHS=200,MEM_BUDGET=390 engine/training/run_eleven_runs.sh
#
#   THE FINAL PAIR. R18 and R19 differ only by --augment, so submit them together
#   and the difference is the augmentation result. 10 channels at batch 4 x accum
#   2 (same gradient as batch 8), 200 epochs, ~15 min/epoch on a 1 TB node:
#     sbatch --array=18-19 --time=96:00:00 -C "GPU_SKU:A100_SXM4&GPU_MEM:80GB" --mem=600GB \
#            --export=ALL,EPOCHS=200,MEM_BUDGET=390 engine/training/run_eleven_runs.sh
#
...
ARRAY_RUNS=(R0 R1 R3 R4 R5 R6 R7 R8 R2 R9 R10 R11 R12 R13 R14 R15 R16 R17 R18 R19)   # 11-12: 40 GB follow-ups; 13-17: combined-split; 18-19: the final pair
...
case "$RUN" in R3|R10|R13|R14|R15|R16|R17|R18|R19)
