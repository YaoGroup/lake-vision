...
# =============================================================================
# TRAIN LAKE-VISION CLASSIFIER WITH LEARNED CLOUDY WEIGHTS
# =============================================================================
#
# Trains the LakeDrainageClassifier with cloudy sequence and learned
# per-timestep weights. This allows the model to learn which temporal
# positions matter most, modulated by the cloudy-tile usefulness predictions.
#
# PREREQUISITES:
...
#
# USAGE:
#   sbatch run_training_cloudyweights.sh
#
# OUTPUT:
...
# Model save path
SAVE_PATH="$MODELS_DIR/lakevision_cloudyweights.pth"
...
echo "=============================================="
echo "Lake Vision Training - Cloudy Weights"
echo "=============================================="
echo "Labels CSV: $LABELS_CSV"
echo "NC Directory: $NC_DIR"
echo "Model save path: $SAVE_PATH"
echo "Features: use_cloudyseq + learn_cloudy_weights"
echo "=============================================="
...
export WANDB_RUN_GROUP="cloudy-weights"
...
# Training configuration with cloudy sequence and learned weights
