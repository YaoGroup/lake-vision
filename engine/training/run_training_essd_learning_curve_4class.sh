#!/bin/bash
#SBATCH --job-name=lv_essd_lcurve_4c
...
# =============================================================================
# ESSD 4-CLASS LEARNING CURVE (MD merged into LD)
# =============================================================================
#
# Same as run_training_essd_learning_curve.sh but with --merge_classes MD LD,
# producing a 4-class model: ND, HF, MDLD, CD.
# N values: 200 400 600 800 1000 (array tasks 0-4).
#
# USAGE:
#   sbatch run_training_essd_learning_curve_4class.sh
# =============================================================================
...
MODELS_DIR="$SHERLOCK_DIR/models/essd/lcurve_4class"
...
SAVE_PATH="$MODELS_DIR/lakevision_essd_lcurve_4class_N${N_TRAIN}.pth"
...
echo "=============================================="
echo "ESSD 4-class Learning Curve — N_train=$N_TRAIN"
echo "=============================================="
...
export WANDB_RUN_GROUP="essd_lcurve_4class"
...
python3 -u "$REPO_DIR/engine/training/run_training.py" \
    ...
    --merge_classes MD LD \
    --wandb_name "essd_lcurve_4class_N${N_TRAIN}" \
    --save_path "$SAVE_PATH"
