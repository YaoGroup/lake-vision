#!/bin/bash
#SBATCH --job-name=lv_essd_comb_hc_aug
...
# =============================================================================
# ESSD HIGH-CAPACITY + 8x AUGMENTATION — COMBINED 2018+2019
# =============================================================================
#
# High-capacity model (frontcnn_base_ch=16, num_layers=3, clstm_hidden=64)
# with 8x data augmentation (all D4 symmetries: rotations + flips).
# 400 epochs, bs=8 (A100 80GB VRAM).
# 168h walltime (7 days) since 8x augmentation = 8x batches per epoch.
#
# USAGE:
#   sbatch run_training_essd_combined_highcap_augment.sh
# =============================================================================
...
MODELS_DIR="$SHERLOCK_DIR/models/essd/combined_highcap_augment"
...
SAVE_PATH="$MODELS_DIR/lakevision_essd_combined_highcap_augment.pth"
...
echo "=============================================="
echo "ESSD High-capacity + 8x Augmentation"
echo "=============================================="
...
export WANDB_RUN_GROUP="essd_combined_highcap_augment"
...
python3 -u "$REPO_DIR/engine/training/run_training.py" \
    ...
    --augment \
    --epochs 400 \
    --wandb_name "essd_combined_highcap_augment" \
    --save_path "$SAVE_PATH"
