#!/bin/bash
#SBATCH --job-name=lv_essd_crossyear_io
...
# =============================================================================
# ESSD ABLATION — CROSS-YEAR, IMAGERY-ONLY
# =============================================================================
#
# Ablation of run_training_essd_crossyear.sh: disables water_area,
# cloudy_seq_rgb, and lake polygon mask streams (raw RGB imagery only).
# Reads from raw sat-tile-stack output, not composites.
#
# USAGE:
#   sbatch run_training_essd_crossyear_imageryonly.sh
# =============================================================================
...
MODELS_DIR="$SHERLOCK_DIR/models/essd/crossyear_imageryonly"
...
SAVE_PATH="$MODELS_DIR/lakevision_essd_crossyear_imageryonly.pth"
...
echo "=============================================="
echo "ESSD Ablation: Cross-year (imagery-only)"
echo "=============================================="
...
export WANDB_RUN_GROUP="essd_crossyear_imageryonly"
...
python3 -u "$REPO_DIR/engine/training/run_training.py" \
    ...
    --wandb_name "essd_crossyear_imageryonly" \
    --save_path "$SAVE_PATH"
